  ...
  return (
    ...
    <View style = {styles.imgContainer}>
        <Image style = {styles.roverImg} source={require('../assets/rover.jpg')}></Image>
            <ScrollView style = {styles.roverTextContainer}>
              <Text style = {styles.roverText}>
                    Mars Exploration Rover (MER) est une mission double de la NASA lancée en 2003 et composée de deux robots mobiles ayant pour objectif
                    d'étudier la géologie de la planète Mars et en particulier le rôlece
                    ...
                    sur un mât à 1,5 mètre de hauteur, un outil pour abraser la surfaectromètre à rayons X, un spectromètre Mössbauer et une caméra
